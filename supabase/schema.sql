...
-- ---------------------------------------------------------------------------
-- Character Image Variants (Character Studio)
-- ---------------------------------------------------------------------------
-- Stores refined image variants for characters, enabling A/B comparisons
-- and preserving iteration history instead of overwriting the main portrait
